...
- **Offer Engine V3**: A 5-layer structured Offer Decision Engine that consumes upstream data and produces primary, alternative, and rejected offer options based on layers like Outcome, Mechanism, Delivery, Proof, and Risk Reduction. Supports user selection of preferred offer option.
