...
- **Funnel Engine V3**: An 8-layer Funnel Decision Engine (Eligibility Detection, Offer-to-Funnel Fit, Audience Friction Modeling, Trust Path Construction, Proof Placement Logic, Commitment Level Matching, Funnel Integrity Guard, Funnel Strength Scoring). Produces primary/alternative/rejected funnel outputs with trust path, proof placement, and friction mapping. Supports user selection of preferred funnel. Hard-fail boundary enforcement for 13 blocked domains.
