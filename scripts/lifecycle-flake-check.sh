...
#
# Runs the full lifecycle scenario suite N times (default 100). Reports
# every failed iteration. Exit code is non-zero if ANY iteration failed.
#
# Usage:
#   bash scripts/lifecycle-flake-check.sh           # 100 iterations
#   N=20 bash scripts/lifecycle-flake-check.sh      # custom count
set -u
