...
export { CLASSIFIER_VERSION, HOOK_ARCHETYPES, NARRATIVE_FRAMEWORKS, CTA_TYPES, OFFER_TYPES, EMOTIONAL_TRIGGERS, AWARENESS_STAGES, POSITIONING_STYLES, CONTENT_FORMAT_INTENTS, PRIMARY_GOALS, CORE_MARKETING_PROMISES } from "./types";
export type { CoreMarketingPromise } from "./types";
