...
function volumeMultiplierFromBudget(budget) {
    if (budget >= 5000)
        return 1.5;
    if (budget >= 2000)
        return 1.2;
...
function classifyBusinessType(businessType) {
...
export function deriveIndustryBaseline(objective, businessType, monthlyBudget) {
