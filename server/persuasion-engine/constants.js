...
export const OBJECTION_PROOF_MAP = {
...
export const EDUCATION_FIRST_MODES = ["education_led", "diagnostic_led", "empathy_led", "education_proof_hybrid"];
...
export const AWARENESS_PERSUASION_MAP = {
...
export const MESSAGE_STEP_CATEGORY_MAP = {
...
export const FUNNEL_PERSUASION_COMPATIBILITY = {
