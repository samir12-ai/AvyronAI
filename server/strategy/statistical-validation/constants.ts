...
export interface CanonicalSignalDefinition {
  clusterId: string;
...
export const CANONICAL_SIGNAL_REGISTRY: Record<string, CanonicalSignalDefinition> = {
  transparency_proof: {
...
export const PERSUASION_DRIVER_CLASSIFIERS: Record<string, RegExp> = {
...
export const AWARENESS_TRIGGER_CLASSIFIERS: Record<string, RegExp> = {
...
export const AWARENESS_ENTRY_CLASSIFIERS: Record<string, RegExp> = {
