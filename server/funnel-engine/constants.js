...
export const AWARENESS_TO_FUNNEL_MAP = {
...
export const AWARENESS_BLOCKED_FUNNELS = {
...
export const ENTRY_ROUTE_TO_FUNNEL_FAMILIES = {
    pain_entry: {
...
export const TRIGGER_CLASS_TO_FUNNEL_FAMILY = {
    hidden_cost: {
...
export const AWARENESS_ROUTE_TO_ENTRY_MECHANISMS = {
    pain_entry: {
...
export const TRIGGER_CLASS_TO_ENTRY_MECHANISMS = {
    hidden_cost: {
