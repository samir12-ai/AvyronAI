...
export const STATUS = {
  ...
  SIGNAL_GROUNDING_FAILED: "SIGNAL_GROUNDING_FAILED",
} as const;

export const SIGNAL_GROUNDING_MAX_RETRIES = 2;
...
export const STABILITY_MIN_PROOFABILITY = 0.15;
export const STABILITY_MIN_TRUST_ALIGNMENT = 0.10;
