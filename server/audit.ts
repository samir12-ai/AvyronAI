...
export type AuditEventType =
  ...
  | "EXECUTION_RESUMED"
  | "CALENDAR_CREATED"
  | "CALENDAR_ENTRIES_GENERATED"
  | "REQUIRED_WORK_CALCULATED"
  | "STUDIO_ITEMS_CREATED"
  ...
  | "CONTINUITY_REANCHOR"
  | "CONTINUITY_DEAD_CYCLE"
  | "CONTINUITY_MISSED_WINDOWS"
  | "CONTINUITY_HEARTBEAT_STALE"
  | "CONTINUITY_CHAIN_LAG"
  | "CONTINUITY_REPLICA_CONFLICT";
