...
export function estimateTokenUsage(competitorCount, totalComments, totalPosts) {
...
export function selectExecutionMode(projectedTokens) {
...
export function computeTokenBudget(competitorCount, totalComments, totalPosts) {
...
export function applySampling(posts, comments, mode) {
    let maxPosts;
    let maxComments;
    switch (mode) {
        case "FULL":
