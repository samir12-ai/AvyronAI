export const ENGINE_PRIORITY_ORDER = [
  ...
  { id: "offer", name: "Offer Engine", priority: 5, tier: "OFFER" },
  { id: "funnel", name: "Funnel Engine", priority: 6, tier: "MESSAGING" },
  { id: "awareness", name: "Awareness Engine", priority: 7, tier: "MESSAGING" },
  { id: "persuasion", name: "Persuasion Engine", priority: 8, tier: "MESSAGING" },
  { id: "integrity", name: "Integrity Engine", priority: 9, tier: "MESSAGING" },
  { id: "statistical_validation", name: "Statistical Validation", priority: 10, tier: "FINANCIAL" },
  { id: "budget_governor", name: "Budget Governor", priority: 11, tier: "FINANCIAL" },
  { id: "channel_selection", name: "Channel Selection", priority: 12, tier: "CHANNEL" },
  { id: "iteration", name: "Iteration Engine", priority: 13, tier: "CREATIVE" },
  { id: "retention", name: "Retention Engine", priority: 14, tier: "CREATIVE" },
] as const;
