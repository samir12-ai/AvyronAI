...
export function tokenize(text) {
    ...
    return words.map(word => {
        ...
        if (CONCEPT_MAP[stripped])
            return CONCEPT_MAP[stripped];
        return stripped;
    });
}
...
function unigramCosine(tfA, tfB) {
...
export function isSemanticMatch(reference, output, threshold = SEMANTIC_MATCH_THRESHOLD) {
