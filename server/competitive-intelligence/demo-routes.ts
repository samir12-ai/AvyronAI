...
const DEMO_COMPETITORS = [
  {
    ...
    postingFrequency: 6,
    contentTypeRatio: JSON.stringify({ reels: 55, static: 30, stories: 15 }),
    engagementRatio: 3.8,
  ...
  },
  {
    ...
    postingFrequency: 5,
    contentTypeRatio: JSON.stringify({ reels: 65, static: 25, stories: 10 }),
    engagementRatio: 4.2,
  ...
  },
  {
    ...
    postingFrequency: 4,
    contentTypeRatio: JSON.stringify({ reels: 70, static: 15, stories: 15 }),
    engagementRatio: 5.1,
