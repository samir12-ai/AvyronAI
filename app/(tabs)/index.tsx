...
import ReasoningCardsPanel from '@/components/ReasoningCardsPanel';
...
function DashboardActive({ campaignId, isDark, narrativeRefreshKey }: {
  ...
  return (
    <>
      ...
      <MarketSnapshotCard campaignId={campaignId} isDark={isDark} />
      <ReasoningCardsPanel campaignId={campaignId} isDark={isDark} />
      <BlockedReasonsCard
...
export default function DashboardScreen() {
  ...
  const onRefresh = useCallback(async () => {
    setRefreshing(true);
    await Promise.all([fetchMetrics(), fetchConfidence(), fetchDataMode()]);
    setRefreshing(false);
